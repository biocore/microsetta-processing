...
echo -e "${sbatch_script_common} bash 08.cleanup.sh" | sbatch --dependency=afterok:${dependency} --export=DATETAG=${datetag},QIIME_VERSION=${QIIM_VERSION} -N 1 -c 1 --mem=1g --time=1:00:00 --job-name TMI-cleanup
